...
class Program
{
    ...
    static void Main(string[] args)
    {
        ...
        Print("TIER 1 ORDER BY PRICE THEN BY NAME SKIP 2 TAKE 4", r4);

        var r6 = products.FirstOrDefault();
        Console.WriteLine("First: " + r6);

        var r7 = products.Where(p => p.Price > 3000.0).FirstOrDefault();
        Console.WriteLine("First above 3k: " + r7);

        var r8 = products.Where(p => p.Id == 3).SingleOrDefault();
        Console.WriteLine("Single: " + r8);

        var r9 = products.Where(p => p.Id == 30).SingleOrDefault();
        Console.WriteLine("Single 30 id: " + r9);
        ...
        var r15 = products
            .Where(p => p.Category.Id == 1)
            .Select(p => p.Price) //map
            .Aggregate(0.0, (x, y) => x + y); //reduce
